...
- [ ] T005 Configure docusaurus.config.ts with docs-only mode (routeBasePath: '/')
- [ ] T006 Configure docusaurus.config.ts with GitHub Pages settings (baseUrl, organizationName, projectName)
- [ ] T007 Configure docusaurus.config.ts to disable blog (blog: false)
- [ ] T008 Configure sidebars.ts with autogenerated sidebar from docs/ folder
- [ ] T009 [P] Create module folder structure in physical-ai-book/docs/:
  - module-1-intro/
  - module-2-embodied/
  - module-3-humanoid/
  - module-4-perception/
  ...
  - module-6-learning/
  - module-7-future/
- [ ] T010 [P] Create static asset folder structure in physical-ai-book/static/img/:
  - module-1/
  - module-2/
  - module-3/
  - module-4/
  ...
  - module-6/
  - module-7/
- [ ] T011 [P] Create diagrams folder at physical-ai-book/static/diagrams/
- [ ] T012 Update physical-ai-book/src/css/custom.css with minimal book-friendly styling
